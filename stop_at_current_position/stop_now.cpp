...
*/
  ...
  Mavsdk mavsdk;
   ...
   // auto system = fut.get();
    ...
    const Action::Result takeoff_result = action.land ();
...
*/
//    std::ofstream myfile;
//    myfile.open("/home/doannd/MAVSDK_Project_Test/data/location",std::ios::app);
//    myfile << alt << ",";
//    myfile << std::fixed << std::setprecision(5) << lat << ",";
//    myfile << std::fixed << std::setprecision(5) << lon << "\n";
//    myfile.close();
